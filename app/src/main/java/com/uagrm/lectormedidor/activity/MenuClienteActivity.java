...
import com.uagrm.lectormedidor.fragment.FacturaFragment;
...
public class MenuClienteActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        tv_bar_titulo.setText("Mis facturas");
    ...
    private void registroDispositivo() {
        ...
        if (!token.equals("")) {
            RegistrarDispositivoClientePojo registrarDispositivoClientePojo = new RegistrarDispositivoClientePojo();
            registrarDispositivoClientePojo.setIdCliente(preferencia.getClienteId());;
            registrarDispositivoClientePojo.setTokenFirebase(token);
            LectorMedidorService service = Cliente.getClient();
            Call<Respuesta<String>> call = service.registrarDispositivoCliente(registrarDispositivoClientePojo);
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem menuItem) {
        switch (menuItem.getItemId()) {
            case R.id.nav_mis_facturas:
                tv_bar_titulo.setText("Mis facturas");
                getSupportFragmentManager().popBackStack(null, FragmentManager.POP_BACK_STACK_INCLUSIVE);
                goFragment(new FacturaFragment(), "consulta_producto");
                break;
    ...
    private void cerrarSesion() {
        ...
        Intent ventana = new Intent(MenuClienteActivity.this, LoginActivity.class);
        startActivity(ventana);
        overridePendingTransition(R.anim.anim_slide_in_right, R.anim.anim_slide_in_left);
        MenuClienteActivity.this.finish();
    }
